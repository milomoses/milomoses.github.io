...
this.v=0
this.x=(1-n)*s1-2*(-1)**n*r
this.y=(1-n)*s2-2*(-1)**n*r
...
if (started){
  ...
  textSize(15)
  fill(50)
  text("Player 1 has "+str(P1.hp)+" hp",s1/2-65,s2/2-20)
  text("Player 0 has "+str(P0.hp)+" hp",s1/2-65,s2/2+20)
  if (P0.hp<=0){
  Winner=1
  }
  if (P1.hp<=0){
  ...
  if (Winner==1){
  textSize(50)
  text("Player 1 won!",s1/2-145,s2/2+20)
  }

  if (Winner==0){
  textSize(50)
  text("Player 0 won!",s1/2-145,s1/2+20)
  }
  }
}
}
